    ...
    <div class="w-full h-full p-4 xl:min-h-100">
      ...
      <div class="flex justify-between">
        ...
        <input
          ...
          id="targetName"
          type="text"
          class="block w-full px-3 placeholder-gray-400 transition duration-150 ease-in-out border border-gray-300 rounded-md appearance-none focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5"
        />
        <button
          v-if="!editing"
          @click="
