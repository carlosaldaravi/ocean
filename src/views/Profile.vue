                        ...
                        >
                          <div>
                            <div class="flex items-center mx-auto">
                              <span
                                class="flex items-center justify-center flex-shrink-0 w-12 h-12 bg-red-100 rounded-full sm:h-10 sm:w-10"
                              >
                                <svg
                              ...
                              <h3
                                class="ml-4 text-lg font-medium leading-6 text-gray-900"
                                id="modal-headline"
                              >
                                Eliminar
                              </h3>
